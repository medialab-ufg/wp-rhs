    ...
    <div class="col-xs-12 comunidade">
        ...
        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
            <div class="btn-group" role="group">
                <button type="button" id="sobre" class="btn btn-primary" href="#tab1" data-toggle="tab">
                    <span class="fa fa-th" aria-hidden="true"></span>
                    <div class="hidden-xs">Sobre</div>
                </button>
            </div>
            <div class="btn-group" role="group">
                <button type="button" id="posts" class="btn btn-default" href="#tab2" data-toggle="tab">
