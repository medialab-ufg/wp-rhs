(function () {
	tinymce.PluginManager.add( 'placeholder', function ( editor ) {
		...
		var Label = function () {
			...
			attrs = {id: 'mce-placeholder-plugin-label', style: {color: 'rgb(51, 51, 51)', position: 'absolute', 'font-size': '16px', 'font-family': 'Georgia', top: '10px', left: 0, color: '#888', padding: '9px 10px', width: '98%', overflow: 'hidden', display: 'none' }};
