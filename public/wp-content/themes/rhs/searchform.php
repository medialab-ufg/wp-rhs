 ...
 */
?>
<form autocomplete="off" class="form-search-rhs navbar-form navbar-left" role="search" action="<?php echo home_url(RHSSearch::BASE_URL); ?>" method="get" id="menuPesquisa">
