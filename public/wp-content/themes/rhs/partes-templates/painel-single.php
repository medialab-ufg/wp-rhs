				...
				<div class="post-meta">
					...
					<div class="pull-right share share-wrap">
						<span class="hidden-print" style="">
							...
							<a href="whatsapp://send?text=<?php the_title_attribute( 'after= ' ); ?><?php the_permalink(); ?>" data-text="<?php the_title(); ?>" data-href="<?php the_permalink(); ?>" target="_top" onclick="window.parent.null">
