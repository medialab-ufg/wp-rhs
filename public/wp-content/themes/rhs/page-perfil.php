                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                        <?php
                                                        foreach ( $userOBJ->getLinks( true ) as $key => $link ) { ?>
                                                            <div class="col-sm-6">
                                                                <label for="edit-titulo">Titulo</label>
                                                                <input type="text" name="rhs_links[title][]" id="edit-titulo"
                                                                       value="<?php echo $link['title'] ?>" class="form-control">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label for="edit-links">URL</label>
                                                                <input type="url" name="rhs_links[url][]" id="edit-links"
                                                                       value="<?php echo $link['url'] ?>" class="form-control">
                                                            </div>
                                                        <?php } ?>
                                                    <div class="help-block">
                                                        <a class="js-add-user-link"
                                                           style="outline: none !important; box-shadow: none !important; text-decoration: none; cursor: pointer;">
                                                            + <?php _e( 'Adicionar' ); ?>
                                                        </a>
                                                    </div>
                                                </div>
