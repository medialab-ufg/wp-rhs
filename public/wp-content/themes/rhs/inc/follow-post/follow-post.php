...
class RHSFollowPost {
    ...
    function show_header_follow_post_box($post_id) {
        ...
        if (is_user_logged_in()) {
            ...
            $button_html .= ($isFollowing) ? "<span class='fa-stack'><i class='fa fa-rss fa-stack-1x text-danger'></i><i class='fa fa-remove fa-stack-2x'></i></span>" : "<span class='fa-stack follow-post'><i class='fa fa-rss'></i></span>";
            $button_html .= "</button>";
            echo $button_html;
        }
    }
